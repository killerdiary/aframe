 ...
 * Gifview
 */
class GifView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0, defStyleRes: Int = 0) : View(context, attrs, defStyleAttr, defStyleRes) {
    ...
    init {
        setViewAttributes(context, attrs, defStyleAttr, defStyleRes)
    }

    private fun setViewAttributes(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        /**
        ...
        val a = context.obtainStyledAttributes(attrs, R.styleable.GifView, defStyleAttr, defStyleRes)
        //-1 is default value
        mMovieResourceId = a.getResourceId(R.styleable.GifView_gif, -1)
        isPaused = a.getBoolean(R.styleable.GifView_paused, false)
        a.recycle()
