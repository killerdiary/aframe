...
//                .into(view);
        Glide.with(context).setDefaultRequestOptions(new RequestOptions().centerCrop(context).override(sWidthPix / spancount, sWidthPix / spancount).diskCacheStrategy(DiskCacheStrategy.RESOURCE).placeholder(R.drawable.loadfaild));
    }
