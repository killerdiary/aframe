...
public class CropImageView extends TransformImageView {
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        float targetAspectRatioX = Math.abs(a.getFloat(R.styleable.UCropView_ucrop_aspect_ratio_x, DEFAULT_ASPECT_RATIO));
        float targetAspectRatioY = Math.abs(a.getFloat(R.styleable.UCropView_ucrop_aspect_ratio_y, DEFAULT_ASPECT_RATIO));
