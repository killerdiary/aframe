...
public class StringHttpEntity extends HttpEntity {
    ...
    public StringHttpEntity(final ConcurrentHashMap<String, String> params, String charsetName) {
        final String charset = TextUtils.isEmpty(charsetName) ? DEFAULT_CHARSET : charsetName;
    ...
    public String format(final ConcurrentHashMap<String, String> params, final String charset) {
