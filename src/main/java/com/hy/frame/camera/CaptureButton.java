...
public class CaptureButton extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        btn_after_outside_radius = (float) (getWidth() / 7);
        btn_after_inside_radius = (float) (btn_outside_radius * 0.65);
...
//        btn_result_radius = 80;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (STATE_SELECTED == STATE_LESSNESS || STATE_SELECTED == STATE_RECORD) {
            ...
            int surplus = (int) (20 - 20 * progress / 360);
            canvas.drawText((surplus < 10 ? "0" : "") + String.valueOf(surplus), btn_center_X - textSize / 2, btn_center_Y + textSize / 2, paintText);
