...
import com.hy.frame.adapter.ImageViewPagerAdapter
 ...
 */
class AlbumPagerActivity : BaseActivity(), ViewPager.OnPageChangeListener {
    ...
    override fun initData() {
        ...
        adapter = ImageViewPagerAdapter(context!!, datas, Glide.with(this))
    ...
    companion object {
        ...
        val ARG_CHECK_DATA = "arg_check_data"
