...
public class AudioPlayer implements IPlayComplete {
    ...
    private void createAudioTrack() throws Exception {
        ...
        // 获得构建对象的最小缓冲区大小
        int minBufSize = AudioTrack.getMinBufferSize(mAudioParam.getmFrequency(), mAudioParam.getmChannel(), mAudioParam.getmSampBit());
        ...
        mAudioTrack = new AudioTrack(AudioManager.STREAM_MUSIC, mAudioParam.getmFrequency(), mAudioParam.getmChannel(), mAudioParam.getmSampBit(), minBufSize,
