...
class WaveSideBar @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr) {
    ...
    private var mIndexItems: Array<String>? = null
     ...
     */
    private var mTextAlignment: Int = 0
    ...
    init {
        ...
        mLazyRespond = typedArray.getBoolean(R.styleable.WaveSideBar_wsbLazyRespond, false)
        mTextColor = typedArray.getColor(R.styleable.WaveSideBar_wsbTextColor, Color.GRAY)
        mTextSize = typedArray.getDimension(R.styleable.WaveSideBar_wsbTextSize, sp2px(DEFAULT_TEXT_SIZE))
        mMaxOffset = typedArray.getDimension(R.styleable.WaveSideBar_wsbMaxOffset, dp2px(DEFAULT_MAX_OFFSET))
        mSideBarPosition = typedArray.getInt(R.styleable.WaveSideBar_wsbPosition, POSITION_RIGHT)
        mTextAlignment = typedArray.getInt(R.styleable.WaveSideBar_wsbTextAlignment, TEXT_ALIGN_CENTER)
        typedArray.recycle()
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        when (event.action) {
            MotionEvent.ACTION_DOWN -> if (mStartTouchingArea.contains(eventX, eventY)) {
                mStartTouching = true
