...
public class CameraView extends FrameLayout {
     ...
     *
     * @param facing The camera facing. Must be either
     */
    ...
    private class CallbackBridge implements CameraViewImpl.Callback {
        ...
        public void onCameraOpened() {
            MyLog.INSTANCE.e(getClass(), "onCameraOpened");
        ...
        @Override
        public void onPreviewFrame(Bitmap bmp) {
            for (Callback callback : mCallbacks) {
                callback.onPreviewFrame(CameraView.this, bmp);
            }
        }
