...
public class CameraView extends FrameLayout {
    ...
    private boolean isVideo, isRecording;
    ...
    public void initRecorder(File file, Activity activity) throws IOException {
        if (mMediaRecorder != null) {
            closeRecorder();
        }
        ...
        mMediaRecorder.setVideoSize(640, 800);
    ...
    public int getLastKnownDisplayOrientation() {
        return mDisplayOrientationDetector.getLastKnownDisplayOrientation();
    }
