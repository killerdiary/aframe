 ...
 * @time 2017/7/6 16:22
 */
class MultImageActivity : BaseActivity(), ViewPager.OnPageChangeListener {
    ...
    override fun getLayoutId(): Int = R.layout.act_camera_image_mult

    override fun initView() {
        vPager = findViewById(R.id.camera_image_mult_vPager)
        llyPoint = findViewById(R.id.camera_image_mult_llyPoint)
    ...
    override fun initData() {
        ...
        for (item in datas!!) {
            val v = View.inflate(getCurContext()!!, R.layout.item_camera_image, null)
            val img = findViewById<PhotoView>(R.id.camera_image_i_imgShow, v)!!
            ComUtil.displayImage(Glide.with(getCurContext()), img, item)
